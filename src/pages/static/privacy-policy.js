  ...
  return (
    ...
    >
      <div className="content">
        ...
        <h4>Personal data</h4>
        <p>
          We don’t aim to collect personal information from users unless you
          provide us with it through email or contact form. We also don’t
          require users to create an account to use the tool.
        </p>
        ...
        <ul className="list-disc">
          ...
          <li>
            Website: <a href="https://tiknotes.app/">https://tiknotes.app/</a>
          </li>
        </ul>
      </div>
    </LayoutMain>
